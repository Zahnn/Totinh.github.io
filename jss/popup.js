            ...
            $('h1').click(function() {
                ...
                $(this).next('#k').slideDown('fast');
					...
					$("#divResult").fadeIn(2000,function()
							...
							$("#divResult2").html("<p>♥ Ừa thì anh biết anh đẹp trai thật. Nhưng thôi em yêu anh nhiều vậy thì anh đành phải yêu em vậy.<img src='http://duminhphongadv.com/files/assets/4.png'/></p></br>");
							$("#divResult2").fadeIn(2000,function()
									{
									$("#divResult3").fadeOut(0);
									$("#divResult3").html("<p>Vậy hãy để trái tim này của anh thuộc về em một lần này và mãi mãi nhá !!<img src='http://duminhphongadv.com/files/assets/5.png'/></p></br>");
